...
We are pleased to submit our manuscript, \textbf{``Resolving target-count bias in network proximity Z-scores through perturbation efficiency: A methodological audit using \textit{Hypericum perforatum} constituents,''} for consideration as a Research Article in \textit{Scientific Reports}.
