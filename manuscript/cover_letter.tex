...
We are pleased to submit our manuscript, \textbf{``Perturbation efficiency resolves target-count bias in network proximity metrics,''} for consideration as a Research Article in \textit{Scientific Reports}.
