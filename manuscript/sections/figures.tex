...
Quercetin: Z = $-$5.4, $p < 10^{-6}$; Hyperforin: Z = $-$3.9, $p < 0.001$.
...
At this threshold, Quercetin exhibits closer proximity but weaker influence; Hyperforin exhibits greater influence despite more distant topology (note: proximity ranking reverses at $\geq$700).
Hyperforin: proximity Z = $-$3.9, influence Z = +10.3 ($p < 10^{-16}$).
