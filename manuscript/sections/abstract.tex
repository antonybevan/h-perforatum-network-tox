...
In physical distance space, Hyperforin is closer to drug-induced liver injury (DILI) genes, a ranking that is correctly and stably captured by random walk--based influence propagation.
...
Our results demonstrate that proximity Z-scores are ill-suited for comparative prioritization when target set sizes differ, and that influence-based propagation provides a more stable and theoretically sound framework for network toxicology.
