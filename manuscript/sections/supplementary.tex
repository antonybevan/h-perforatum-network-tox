...
\addlinespace
& Hyperforin (10) & 0.0142 & 0.0097 & 0.1138 & +10.27 \\
& Quercetin (62) & 0.0147 & 0.0040 & 0.0322 & +4.42 \\
\addlinespace
\multicolumn{6}{l}{\textit{Expression-weighted influence (at $\geq$900)}} \\
\addlinespace
& Hyperforin (10) & 0.0198 & 0.0125 & 0.1330 & +9.07$^*$ \\
& Quercetin (62) & 0.0208 & 0.0051 & 0.0493 & +5.56$^*$ \\
\bottomrule
\end{tabular}
...
\footnotesize
$^\dagger$Estimated from EWI pipeline outputs.\\
$^*$Significance remains high despite tissue-specific attenuation.
\end{minipage}
\end{table}
