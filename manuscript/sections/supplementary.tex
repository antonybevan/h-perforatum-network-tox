...
\begin{table}[ht]
\centering
\caption{\textbf{Table S9. Permutation test summary statistics.}
Null distribution parameters from $n = 1{,}000$ degree-matched permutations.
Random seed: 42. FDR correction: Benjamini--Hochberg.}
\label{tab:S9}
\vspace{0.5em}
...
\midrule
\multicolumn{6}{l}{\textit{Shortest-path proximity}} \\
\addlinespace
& Hyperforin & 1.78 & 0.124 & 1.30 & $-$3.86 \\
& Quercetin & 2.04 & 0.066 & 1.68 & $-$5.44 \\
\addlinespace
\multicolumn{6}{l}{\textit{Random walk influence (RWR)}} \\
\addlinespace
& Hyperforin & 0.042 & 0.0070 & 0.114 & +10.27 \\
& Quercetin & 0.018 & 0.0032 & 0.032 & +4.42 \\
\addlinespace
\multicolumn{6}{l}{\textit{Expression-weighted influence (EWI)}} \\
\addlinespace
& Hyperforin & 0.050 & 0.0092 & 0.133 & +9.07 \\
& Quercetin & 0.024 & 0.0045 & 0.049 & +5.56 \\
\bottomrule
\end{tabular}
\end{table}
