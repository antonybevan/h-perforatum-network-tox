...
To resolve the target-count paradox, we computed per-target network influence (PTNI), reframing polypharmacology as an efficiency problem rather than a coverage problem (Figure~\ref{fig:fig4}; Table~\ref{tab:ptni}).
