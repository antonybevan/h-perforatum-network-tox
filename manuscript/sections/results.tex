...
Hyperforin's observed influence (0.1138) exceeds the entire bootstrap distribution from Quercetin (mean = 0.0308, 95\% CI = [0.0160, 0.0542]; Table~\ref{tab:bootstrap}).
