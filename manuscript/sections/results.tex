...
\toprule
\textbf{Compound} & \textbf{Targets} & \textbf{Eff. (RWR)} & \textbf{Eff. (EWI)} & \textbf{Eff. Ratio}$^*$ & \textbf{Rob. Ratio}$^\dagger$ \\
\midrule
Hyperforin & 10 & 0.1138 & 0.1330 & --- & --- \\
Quercetin & 62 & 0.0322 & 0.0493 & --- & --- \\
\textbf{Fold difference} & --- & \textbf{3.5}$\times$ (RWR) & \textbf{2.7}$\times$ (EWI) & \textbf{3.5/2.7} & \textbf{3.7/2.8} \\
\bottomrule
\end{tabular}
\end{center}
\vspace{0.5em}

\small $^*$Eff. Ratio: observed average influence ratio. $^\dagger$Rob. Ratio: observed influence / size-matched bootstrap mean (N=10).
